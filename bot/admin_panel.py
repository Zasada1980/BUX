...
async def admin_users_list(callback: CallbackQuery):
    ...
    Делегирует в show_users_list() из panels/users_panel.py
    """
    await callback.answer()  # Немедленный ответ
...
async def admin_clients_stub(callback: CallbackQuery):
    ...
    Делегирует в show_clients_panel() из panels/clients_panel.py
    """
    await callback.answer()  # Немедленный ответ
    await show_clients_panel(callback)
...
async def admin_schedule_stub(callback: CallbackQuery):
    ...
    Делегирует в show_schedule_panel() из panels/schedule_panel.py
    """
    await callback.answer()  # Немедленный ответ
    await show_schedule_panel(callback)
